...
export default function SupportEmailTemplate({ id }: SupportEmail) {
	return (
		<Html lang='es'>
			<Head>
				<Font
			...
			<Body style={styles.main}>
				<Container style={styles.container}>
					...
					<Text style={styles.text}>
						Has enviado un correo solicitando asistencia por un
						problema en PDFizado, este correo es para informarte que
						ha sido recibido y la identificación del mismo es: {id}
					</Text>

					<Text style={styles.text}>
						Te estaremos contactando en los próximos días para dar
						solución a tu caso.
					</Text>
